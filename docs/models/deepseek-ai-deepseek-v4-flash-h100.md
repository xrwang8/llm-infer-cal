---
title: deepseek-ai/DeepSeek-V4-Flash on H100
description: How many H100 GPUs to run deepseek-ai/DeepSeek-V4-Flash.
---

# deepseek-ai/DeepSeek-V4-Flash on H100

_How many H100 GPUs to run deepseek-ai/DeepSeek-V4-Flash._
...
_Generated by_: 
```bash
llm-infer-cal deepseek-ai/DeepSeek-V4-Flash --gpu H100 --engine vllm --lang en
```
