---
title: deepseek-ai/DeepSeek-V3 on H100
description: How many H100 GPUs to run deepseek-ai/DeepSeek-V3.
---

# deepseek-ai/DeepSeek-V3 on H100

_How many H100 GPUs to run deepseek-ai/DeepSeek-V3._
...
_Generated by_: 
```bash
llm-infer-cal deepseek-ai/DeepSeek-V3 --gpu H100 --engine vllm --lang en
```
