---
title: deepseek-ai/DeepSeek-V4-Flash on H800
description: How many H800 GPUs to run deepseek-ai/DeepSeek-V4-Flash.
---

# deepseek-ai/DeepSeek-V4-Flash on H800

_How many H800 GPUs to run deepseek-ai/DeepSeek-V4-Flash._
...
_Generated by_: 
```bash
llm-infer-cal deepseek-ai/DeepSeek-V4-Flash --gpu H800 --engine vllm --lang en
```
