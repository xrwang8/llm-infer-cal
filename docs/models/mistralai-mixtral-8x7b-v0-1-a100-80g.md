---
title: mistralai/Mixtral-8x7B-v0.1 on A100-80G
description: How many A100-80G GPUs to run mistralai/Mixtral-8x7B-v0.1.
---

# mistralai/Mixtral-8x7B-v0.1 on A100-80G

_How many A100-80G GPUs to run mistralai/Mixtral-8x7B-v0.1._
...
- **Prefill latency** 374 ms @ 2000 input tokens `[estimated]`
- **Cluster decode throughput** 157 tok/s `[estimated]`
...
_Generated by_: 
```bash
llm-infer-cal mistralai/Mixtral-8x7B-v0.1 --gpu A100-80G --engine vllm --lang en
```
