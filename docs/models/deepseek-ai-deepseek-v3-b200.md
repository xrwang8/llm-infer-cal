---
title: deepseek-ai/DeepSeek-V3 on B200
description: How many B200 GPUs to run deepseek-ai/DeepSeek-V3.
---

# deepseek-ai/DeepSeek-V3 on B200

_How many B200 GPUs to run deepseek-ai/DeepSeek-V3._
...
_Generated by_: 
```bash
llm-infer-cal deepseek-ai/DeepSeek-V3 --gpu B200 --engine vllm --lang en
```
