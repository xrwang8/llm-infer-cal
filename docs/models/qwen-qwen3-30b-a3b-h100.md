---
title: Qwen/Qwen3-30B-A3B on H100
description: How many H100 GPUs to run Qwen/Qwen3-30B-A3B.
---

# Qwen/Qwen3-30B-A3B on H100

_How many H100 GPUs to run Qwen/Qwen3-30B-A3B._
...
_Generated by_: 
```bash
llm-infer-cal Qwen/Qwen3-30B-A3B --gpu H100 --engine vllm --lang en
```
