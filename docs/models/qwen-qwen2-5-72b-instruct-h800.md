---
title: Qwen/Qwen2.5-72B-Instruct on H800
description: How many H800 GPUs to run Qwen/Qwen2.5-72B-Instruct.
---

# Qwen/Qwen2.5-72B-Instruct on H800

_How many H800 GPUs to run Qwen/Qwen2.5-72B-Instruct._
...
_Generated by_: 
```bash
llm-infer-cal Qwen/Qwen2.5-72B-Instruct --gpu H800 --engine vllm --lang en
```
