---
title: deepseek-ai/DeepSeek-V4-Flash on 910B4
description: How many 910B4 GPUs to run deepseek-ai/DeepSeek-V4-Flash.
---

# deepseek-ai/DeepSeek-V4-Flash on 910B4

_How many 910B4 GPUs to run deepseek-ai/DeepSeek-V4-Flash._
...
- **Prefill latency** 1299 ms @ 2000 input tokens `[estimated]`
- **Cluster decode throughput** 289 tok/s `[estimated]`
...
_Generated by_: 
```bash
llm-infer-cal deepseek-ai/DeepSeek-V4-Flash --gpu 910B4 --engine vllm --lang en
```
