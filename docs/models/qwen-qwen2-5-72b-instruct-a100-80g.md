---
title: Qwen/Qwen2.5-72B-Instruct on A100-80G
description: How many A100-80G GPUs to run Qwen/Qwen2.5-72B-Instruct.
---

# Qwen/Qwen2.5-72B-Instruct on A100-80G

_How many A100-80G GPUs to run Qwen/Qwen2.5-72B-Instruct._
...
- **Cluster decode throughput** 404 tok/s `[estimated]`
...
_Generated by_: 
```bash
llm-infer-cal Qwen/Qwen2.5-72B-Instruct --gpu A100-80G --engine vllm --lang en
```
