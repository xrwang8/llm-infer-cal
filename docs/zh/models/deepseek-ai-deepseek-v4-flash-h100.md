---
title: deepseek-ai/DeepSeek-V4-Flash 跑在 H100
description: deepseek-ai/DeepSeek-V4-Flash 在 H100 上需要多少 GPU。
---

# deepseek-ai/DeepSeek-V4-Flash 跑在 H100

_deepseek-ai/DeepSeek-V4-Flash 在 H100 上需要多少 GPU。_
...
_生成方式_: 
```bash
llm-infer-cal deepseek-ai/DeepSeek-V4-Flash --gpu H100 --engine vllm --lang zh
```
