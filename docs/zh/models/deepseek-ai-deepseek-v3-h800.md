---
title: deepseek-ai/DeepSeek-V3 跑在 H800
description: deepseek-ai/DeepSeek-V3 在 H800 上需要多少 GPU。
---

# deepseek-ai/DeepSeek-V3 跑在 H800

_deepseek-ai/DeepSeek-V3 在 H800 上需要多少 GPU。_
...
_生成方式_: 
```bash
llm-infer-cal deepseek-ai/DeepSeek-V3 --gpu H800 --engine vllm --lang zh
```
