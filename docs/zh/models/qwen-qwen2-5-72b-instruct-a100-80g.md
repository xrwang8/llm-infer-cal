---
title: Qwen/Qwen2.5-72B-Instruct 跑在 A100-80G
description: Qwen/Qwen2.5-72B-Instruct 在 A100-80G 上需要多少 GPU。
---

# Qwen/Qwen2.5-72B-Instruct 跑在 A100-80G

_Qwen/Qwen2.5-72B-Instruct 在 A100-80G 上需要多少 GPU。_
...
- **Prefill latency** 291 ms @ 2000 input tokens `[估算]`
- **Cluster decode throughput** 404 tok/s `[估算]`
...
_生成方式_: 
```bash
llm-infer-cal Qwen/Qwen2.5-72B-Instruct --gpu A100-80G --engine vllm --lang zh
```
