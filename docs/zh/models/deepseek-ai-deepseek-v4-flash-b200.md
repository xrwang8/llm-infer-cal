---
title: deepseek-ai/DeepSeek-V4-Flash 跑在 B200
description: deepseek-ai/DeepSeek-V4-Flash 在 B200 上需要多少 GPU。
---

# deepseek-ai/DeepSeek-V4-Flash 跑在 B200

_deepseek-ai/DeepSeek-V4-Flash 在 B200 上需要多少 GPU。_
...
- **Prefill latency** 647 ms @ 2000 input tokens `[估算]`
- **Cluster decode throughput** 90 tok/s `[估算]`
...
_生成方式_: 
```bash
llm-infer-cal deepseek-ai/DeepSeek-V4-Flash --gpu B200 --engine vllm --lang zh
```
