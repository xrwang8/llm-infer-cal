---
title: Qwen/Qwen2.5-72B-Instruct 跑在 H100
description: Qwen/Qwen2.5-72B-Instruct 在 H100 上需要多少 GPU。
---

# Qwen/Qwen2.5-72B-Instruct 跑在 H100

_Qwen/Qwen2.5-72B-Instruct 在 H100 上需要多少 GPU。_
...
_生成方式_: 
```bash
llm-infer-cal Qwen/Qwen2.5-72B-Instruct --gpu H100 --engine vllm --lang zh
```
